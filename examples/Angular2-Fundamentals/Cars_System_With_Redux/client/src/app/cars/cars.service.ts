...
export class CarsService {
  ...
  details(id) {
    return this.httpService
      .get(`cars/details/${id}`, true)
  }

  like(id) {
    return this.httpService
      .post(`cars/details/${id}/like`, {}, true);
  }

  submitReview(review, id) {
    return this.httpService
      .post(`cars/details/${id}/reviews/create`, review, true);
  }

  allReviews(id) {
    return this.httpService
      .get(`cars/details/${id}/reviews`, true);
  }
